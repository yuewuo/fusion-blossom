...
set output "decoding_latency_T_linear_scale.eps"
...
system("ps2pdf -dEPSCrop decoding_latency_T_linear_scale.eps decoding_latency_T_linear_scale.pdf")

# system("pdf2svg decoding_latency_T_linear_scale.pdf decoding_latency_T_linear_scale.svg")
