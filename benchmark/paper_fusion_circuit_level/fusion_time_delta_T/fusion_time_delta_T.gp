...
set xlabel "Partition Size ({/Symbol D}T)" font default_font
set ylabel "Fusion Time ({/Symbol m}s)" font default_font
set title "p = 0.5%, (32 ({/Symbol D}T+1)) {/Symbol \264} d {/Symbol \264} d"
set size 1,1
...
set output "fusion_time_delta_T.eps"
...
system("ps2pdf -dEPSCrop fusion_time_delta_T.eps fusion_time_delta_T.pdf")

# system("pdf2svg fusion_time_delta_T.pdf fusion_time_delta_T.svg")
